...
const carouselData = [
  {
    id: 1,
    text: "DESIGN",
    bgColor: "linear-gradient(135deg, #8C8073 0%, #A69588 50%, #B8A898 100%)",
    textColor: "#FFFFFF",
  },
  {
    id: 2,
    text: "QUALITY",
    bgColor: "linear-gradient(135deg, #FFD8E8 0%, #F5C2D6 50%, #EBACC4 100%)",
    textColor: "#8C8073",
  },
  {
    id: 3,
    text: "STYLE",
    bgColor: "linear-gradient(135deg, #F8F6F3 0%, #E8E4DF 50%, #D8D2CB 100%)",
    textColor: "#8C8073",
  },
  {
    id: 4,
    text: "LUXURY",
    bgColor: "linear-gradient(135deg, #6B5D52 0%, #8C8073 50%, #A69588 100%)",
    textColor: "#FFFFFF",
  },
]
...
export function HeroCarousel() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
        ...
        {carouselData.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <h1
                className={`text-6xl sm:text-8xl md:text-9xl lg:text-[12rem] font-didact font-normal tracking-[0.1em] transition-all duration-800 ${
                ...
                style={{
                  ...
                  textStroke: `2px ${slide.textColor}`,
      ...
      {/* Slide Counter */}
      <div className="absolute top-8 right-8 text-white/80 font-didact font-normal text-sm tracking-wider z-10">
        <span className="text-lg font-normal">{String(currentSlide + 1).padStart(2, "0")}</span>
